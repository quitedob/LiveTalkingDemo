...
class HubertASR(BaseASR):
    ...
    def __init__(self, opt, parent, audio_processor:Audio2Feature,audio_feat_length = [12,12]):
    ...
    def run_step(self):
        ...
        mel_chunks=self.audio_processor.feature2chunks(feature_array=mel,fps=self.fps,batch_size=self.batch_size,audio_feat_length = self.audio_feat_length, start=self.stride_left_size/2)
